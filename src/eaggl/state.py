...
- `PhewasPhenoState`: PheWAS, phenotype, and anchor-mask runtime state
- `GeneSetRegressionState`: gene-set regression, beta, and prior runtime state
- `GeneSignalHugeState`: Y, HuGE, covariate, and gene-signal runtime state
- `FactorModelState`: factorization outputs, labels, and factor-PheWAS runtime state
"""
...
pegs_initialize_read_x_batch_seed_state = pegs_x_runtime.initialize_read_x_batch_seed_state
pegs_initialize_filtered_gene_set_state = pegs_x_runtime.initialize_filtered_gene_set_state
pegs_maybe_prepare_filtered_correlation = pegs_x_runtime.maybe_prepare_filtered_correlation
pegs_resolve_read_x_run_logistic = pegs_x_runtime.resolve_read_x_run_logistic
pegs_record_read_x_counts = pegs_x_runtime.record_read_x_counts
pegs_standardize_qc_metrics_after_x_read = pegs_x_runtime.standardize_qc_metrics_after_x_read
pegs_maybe_correct_gene_set_betas_after_x_read = pegs_x_runtime.maybe_correct_gene_set_betas_after_x_read
pegs_maybe_limit_initial_gene_sets_by_p = pegs_x_runtime.maybe_limit_initial_gene_sets_by_p
pegs_maybe_prune_gene_sets_after_x_read = pegs_x_runtime.maybe_prune_gene_sets_after_x_read
pegs_initialize_hyper_defaults_after_x_read = pegs_x_runtime.initialize_hyper_defaults_after_x_read
pegs_maybe_adjust_overaggressive_p_filter_after_x_read = pegs_x_runtime.maybe_adjust_overaggressive_p_filter_after_x_read
pegs_apply_post_read_gene_set_size_and_qc_filters = pegs_x_runtime.apply_post_read_gene_set_size_and_qc_filters
...
_compute_noisy_or_anchor_summary_for_projection = eaggl_anchor_aggregation.compute_noisy_or_anchor_summary_for_projection
...
class GeneSetRegressionState:
    ...
    inf_betas_missing: object | None = None
    ...
    inf_betas_orig: object | None = None
    ...
    inf_betas_missing_orig: object | None = None
...
class FactorModelState:
    ...
    factor_labels_phenos: object | None = None
    factor_top_gene_sets: object | None = None
    factor_top_genes: object | None = None
    factor_top_phenos: object | None = None
    ...
    gene_set_discovery_family_mean_similarity: object | None = None
    gene_set_discovery_family_effective_size: object | None = None
    ...
    trait_linkage_evidence_source: object | None = None
    trait_linkage_effect_input_transform: object | None = None
    ...
    trait_linkage_cosine: object | None = None
    trait_linkage_euclidean: object | None = None
    ...
    factor_phewas_Y_p_values: object | None = None
    factor_phewas_Y_one_sided_p_values: object | None = None
    factor_phewas_Y_huber_betas: object | None = None
    factor_phewas_Y_huber_ses: object | None = None
    factor_phewas_Y_huber_zs: object | None = None
    factor_phewas_Y_huber_p_values: object | None = None
    factor_phewas_Y_huber_one_sided_p_values: object | None = None
    factor_phewas_combined_prior_Ys_betas: object | None = None
    factor_phewas_combined_prior_Ys_ses: object | None = None
    factor_phewas_combined_prior_Ys_zs: object | None = None
    factor_phewas_combined_prior_Ys_p_values: object | None = None
    factor_phewas_combined_prior_Ys_one_sided_p_values: object | None = None
    factor_phewas_combined_prior_Ys_huber_betas: object | None = None
    factor_phewas_combined_prior_Ys_huber_ses: object | None = None
...
class EagglState(object):
    ...
    def __init__(self, background_prior=0.05, batch_size=4500):
        ...
        object.__setattr__(self, "_phewas_pheno_state", PhewasPhenoState())
        ...
        object.__setattr__(self, "_factor_model_state", FactorModelState())
        ...
        self.gene_set_discovery_family_mean_similarity = None
        self.gene_set_discovery_family_effective_size = None
        ...
        self.trait_linkage_evidence_source = None
        self.trait_linkage_effect_input_transform = None
        ...
        self.trait_linkage_cosine = None
        self.trait_linkage_euclidean = None
    ...
    def _init_phewas_and_pheno_state(self):
    ...
    def _init_factor_model_state(self):
        return None

    def _initialize_state_slice_defaults(self):
        for slice_name, slice_type in _EAGGL_STATE_SLICES:
    ...
    @property
    def phewas_pheno_state(self):
        return self._refresh_state_slice("_phewas_pheno_state", PhewasPhenoState)
    ...
    @property
    def factor_model_state(self):
        return self._refresh_state_slice("_factor_model_state", FactorModelState)
    ...
    def _project_H_with_fixed_W(self, W, V_new, P_gene_set, P_gene_new, phi=0.0, lambdak=None, n_iter=100, tol=1e-5, normalize_genes=False, cap_genes=False, add_intercept=False):
        ...
        P_gene_set = _compute_noisy_or_anchor_summary_for_projection(P_gene_set)
        P_gene_new = _compute_noisy_or_anchor_summary_for_projection(P_gene_new)
    ...
    # get raw loading values or derived factor-closeness metrics.
    ...
    def get_factor_loadings(self, loadings, loading_type='raw', specific_weight=0.5):
        ...
        allowed = {'raw', 'cosine', 'euclidean', 'euclidean_score', 'specific', 'combined'}
        assert loading_type in allowed

        if loading_type == 'raw':
            return loadings
        if loading_type == 'cosine':
            return eaggl_trait_linkage.factor_basis_cosines(loadings)
        if loading_type == 'euclidean':
            return eaggl_trait_linkage.factor_basis_euclidean_distances(loadings)
        if loading_type == 'euclidean_score':
            return eaggl_trait_linkage.factor_basis_euclidean_scores(loadings)
    ...
    def run_factor(self, max_num_factors=15, phi=1.0, alpha0=10, beta0=1, seed=None, factor_runs=1, consensus_nmf=False, consensus_min_factor_cosine=0.7, consensus_min_run_support=0.5, consensus_aggregation="median", consensus_stats_out=None, learn_phi=False, learn_phi_max_redundancy=0.5, learn_phi_max_redundancy_q90=0.35, learn_phi_runs_per_step=1, learn_phi_min_run_support=0.6, learn_phi_min_stability=0.85, learn_phi_fit_loss_warning_frac=0.05, learn_phi_max_severe_fit_loss_frac=1.0, learn_phi_target_gene_mass=None, learn_phi_target_gene_effective_support=None, learn_phi_size_tolerance_frac=0.25, learn_phi_min_primary_factors=3, learn_phi_max_primary_gene_max_weight_q90=None, learn_phi_max_steps=5, learn_phi_values=None, learn_phi_expand_factor=2.0, learn_phi_weight_floor=None, learn_phi_metric_factor_scope="primary", learn_phi_mass_floor_frac=0.005, learn_phi_only=False, learn_phi_report_out=None, factor_phi_metrics_out=None, factor_phi_factors_out=None, factor_phi_gene_set_clusters_out=None, factor_phi_gene_clusters_out=None, phi_selection_objective="composite", phi_selection_composite_weights=None, phi_selection_target_factor_gene_mass=100.0, phi_selection_size_log2_width=1.0, phi_selection_loading_cap=1.0, phi_selection_min_entity_total_loading=0.01, phi_selection_bridge_concentration_threshold=0.60, phi_selection_coverage_min_loading=0.05, phi_selection_gene_coverage_top_frac=0.05, phi_selection_gene_coverage_top_n=None, phi_selection_annotation_coverage_top_frac=0.05, phi_selection_annotation_coverage_top_n=None, phi_selection_tie_tolerance=0.01, phi_selection_metrics_wide_out=None, phi_selection_metrics_long_out=None, max_num_gene_sets=None, max_num_discovery_gene_sets=None, gene_set_budget_mode="pruned", learn_phi_gene_set_budget_mode=None, factor_backend="full", learn_phi_backend="sentinel_pruned", online_block_size=None, online_epochs=3, online_shuffle_blocks=True, online_warm_start=True, online_max_blocks=None, online_report_out=None, blockwise_gene_set_block_size=None, blockwise_epochs=None, blockwise_shuffle_blocks=None, blockwise_warm_start=None, blockwise_max_blocks=None, blockwise_report_out=None, sketch_size=None, sketch_embedding_dim=16, sketch_selection_method="projected_kmedoids", sketch_random_seed=None, sketch_refinement_passes=0, factors_out=None, factor_metrics_out=None, gene_set_clusters_out=None, gene_clusters_out=None, cluster_row_min_max_loading=0.01, factor_output_scope="primary", learn_phi_prune_genes_num=1000, learn_phi_prune_gene_sets_num=1000, learn_phi_max_num_iterations=None, gene_set_filter_type=None, gene_set_filter_value=None, gene_or_pheno_filter_type=None, gene_or_pheno_filter_value=None, pheno_prune_value=None, pheno_prune_number=None, gene_prune_value=None, gene_prune_number=None, gene_set_prune_value=None, gene_set_prune_number=None, auto_discovery_subset=True, discovery_redundancy_weighting=True, discovery_redundancy_weighting_mode="effective_size", discovery_similarity_threshold=0.35, anchor_pheno_mask=None, anchor_gene_mask=None, anchor_any_pheno=False, anchor_any_gene=False, anchor_gene_set=False, run_transpose=True, max_num_iterations=100, rel_tol=1e-4, min_lambda_threshold=1e-3, lmm_auth_key=None, lmm_model=None, lmm_provider="openai", label_gene_sets_only=False, label_include_phenos=False, label_individually=False, gene_sets_for_labeling=None, factor_top_loading_type="euclidean", keep_original_loadings=False, project_phenos_from_gene_sets=False, pheno_capture_input="weighted_thresholded", trait_linkage_source="combined", trait_linkage_threshold=1.0, trait_linkage_computation_mode="sparse_full", trait_factor_linkage_factor_gene_threshold=0.05, trait_factor_linkage_nnls_min_loading=0.0, trait_factor_linkage_nnls_max_value=1.0, factor_gmt_out=None, no_trait_linkage=False, discovery_model="gene_by_annotation", anchor_aggregation="multi", gene_gene_beta_source="beta", gene_gene_pair_prior=None, gene_gene_pair_prior_effective_size=None, gene_gene_logbf_base="natural", gene_gene_diagonal_weight=0.0, gene_gene_matrix_floor=1e-3, gene_gene_excess_probability=True, gene_gene_row_sum_cap=True, gene_gene_sparsity=0.0, gene_gene_profligate_correction="none"):
        ...
        blockwise_warm_start = blockwise_warm_start if blockwise_warm_start is not None else online_warm_start
        blockwise_max_blocks = blockwise_max_blocks if blockwise_max_blocks is not None else online_max_blocks
        blockwise_report_out = blockwise_report_out if blockwise_report_out is not None else online_report_out
        runtime_kwargs = {
            ...
            "trait_factor_linkage_nnls_min_loading": trait_factor_linkage_nnls_min_loading,
        ...
        accepted = set(inspect.signature(_eaggl_factor_runtime.run_factor).parameters)
        filtered_runtime_kwargs = {
            key: value
    ...
    def factor_metrics_columns():
        return [
            ...
            "factor_gene_mass",
            "factor_size_score",
            "factor_coherence_score",
            "within_factor_target_mean",
            "within_factor_target_enrichment",
            "factor_gene_bridge_count",
            "factor_annotation_bridge_count",
            "factor_top_gene_coverage_count",
            "factor_top_annotation_coverage_count",
            "gene_mass_fraction",
    ...
    def _collect_factor_metrics_records(self):
        ...
        for i in range(self.num_factors()):
            ...
            records.append({
                ...
                "factor_gene_mass": "%.6g" % gene_metrics["mass"],
                "factor_size_score": "",
                "factor_coherence_score": "",
                "within_factor_target_mean": "",
                "within_factor_target_enrichment": "",
    ...
    def write_trait_factor_links(self, output_file=None, output_detail="main"):
        ...
        cosine = (
            np.asarray(self.trait_linkage_cosine, dtype=float)
            if self.trait_linkage_cosine is not None
            else eaggl_trait_linkage.factor_basis_cosines(nnls)
        )
        euclidean = (
            np.asarray(self.trait_linkage_euclidean, dtype=float)
            if self.trait_linkage_euclidean is not None
            else eaggl_trait_linkage.factor_basis_euclidean_distances(nnls)
        )
        is_anchor = (
            ...
            for trait_index, trait_name in enumerate(self.phenos):
                for factor_index in range(self.num_factors()):
                    values = [
                        ...
                        _fmt(cosine[trait_index, factor_index]),
                        _fmt(euclidean[trait_index, factor_index]),
    ...
    def write_clusters(self, gene_set_clusters_output_file=None, gene_clusters_output_file=None, pheno_clusters_output_file=None, write_anchor_specific=False, anchor_genes=None, cluster_row_min_max_loading=0.01, factor_output_scope="primary"):
        ...
        def row_euclidean_loadings(row_loadings):
            row_loadings = np.asarray(row_loadings, dtype=float)
            row_loadings = np.where(np.isfinite(row_loadings), row_loadings, 0.0)
            if row_loadings.size == 0:
                return np.zeros_like(row_loadings)
            squared_norm = float(np.sum(np.square(row_loadings)))
            return np.sqrt(np.maximum(squared_norm + 1.0 - 2.0 * row_loadings, 0.0))
        ...
        if gene_set_clusters_output_file is not None and self.exp_gene_set_factors is not None:
            ...
            with open_gz(gene_set_clusters_output_file, 'w') as output_fh:
                ...
                header = "%s\t%s\t%s\t%s\t%s\t%s\t%s" % (
                    ...
                    "discovery_weight",
                    "discovery_family_mean_similarity",
                    "discovery_family_effective_size",
                )

                if anchors is not None:
                    header = "%s\t%s" % (header, "anchor")

                output_fh.write("%s\t%s\t%s\t%s\t%s\t%s\n" % (header, "cluster", "label", "\t".join(["Factor%d" % (i+1) for i in ordered_inds]), "\t".join(["Cosine_Factor%d" % (i+1) for i in ordered_inds]), "\t".join(["Euclidean_Factor%d" % (i+1) for i in ordered_inds])))
                ...
                for j in range(num_users):
                    ...
                    for i in sorted(range(values_for_cluster.shape[0]), key=key_fn):
                        ...
                        discovery_family_mean_similarity = self.gene_set_discovery_family_mean_similarity[i] if self.gene_set_discovery_family_mean_similarity is not None else "NA"
                        discovery_family_effective_size = self.gene_set_discovery_family_effective_size[i] if self.gene_set_discovery_family_effective_size is not None else "NA"
    ...
    def subset_gene_sets(self, subset_mask, keep_missing=True, ignore_missing=False, skip_V=False, skip_scale_factors=False, filter_reason=None):
        ...
        if self.gene_set_discovery_family_mean_similarity is not None:
            self.gene_set_discovery_family_mean_similarity = self.gene_set_discovery_family_mean_similarity[subset_mask]
        if self.gene_set_discovery_family_effective_size is not None:
            self.gene_set_discovery_family_effective_size = self.gene_set_discovery_family_effective_size[subset_mask]
