...
def _build_gene_gene_pair_matrix(
    ...
    *,
    ...
    if log_fn is not None:
        log_fn(
            "Built gene-gene pair matrix: genes=%d retained_gene_sets=%d beta_source=%s pair_prior=%.6g M_density=%.6g M_mean=%.6g matrix_floor=%.6g diagonal_weight=%.6g"
            % (
