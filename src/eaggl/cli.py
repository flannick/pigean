...
_OPTION_SUMMARY_BY_FLAG = {
    ...
    "--project-phenos-from-gene-sets": "project fixed-W trait linkage from the gene-set basis instead of the gene basis",
    ...
    "--trait-linkage-threshold": "legacy compatibility option ignored by canonical fixed-W phenotype projection",
    "--trait-linkage-computation-mode": "choose the fixed-W trait-linkage computation backend: sparse_full preserves sparse implicit zeros, dense_full densifies before probability conversion",
        ...
        if projection_only_factor_inputs:
            ...
            log(
                ...
                % (
                    ...
                    else parsed_options.factor_gene_set_clusters_in
                )
            )
        else:
