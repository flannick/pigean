...
_resolve_factor_gene_or_pheno_filter_type = eaggl_factor.resolve_factor_gene_or_pheno_filter_type
_resolve_factor_max_num_discovery_genes = eaggl_factor.resolve_factor_max_num_discovery_genes
_build_pre_factor_gene_keep_mask = eaggl_factor.build_pre_factor_gene_keep_mask
...
_maybe_prune_gene_sets_after_x_read = eaggl_io.maybe_prune_gene_sets_after_x_read_for_runtime
_initialize_hyper_defaults_after_x_read = eaggl_io.initialize_hyper_defaults_after_x_read_for_runtime
...
_maybe_adjust_overaggressive_p_filter_after_x_read = eaggl_io.maybe_adjust_overaggressive_p_filter_after_x_read_for_runtime
_apply_post_read_gene_set_size_and_qc_filters = eaggl_io.apply_post_read_gene_set_size_and_qc_filters_for_runtime
