...
def build_main_gibbs_stage_config(options):
    return GibbsStageConfig(
        run_kwargs=dict(
            ...
            gibbs_summary_mode=options.gibbs_summary_mode,
            write_gibbs_global_filtered_summaries=options.write_gibbs_global_filtered_summaries,
            gene_set_p_active_threshold=options.gene_set_p_active_threshold,
            ...
            max_post_beta_rhat=options.max_post_beta_rhat,
            max_rel_prior_beta_inconsistency=options.max_rel_prior_beta_inconsistency,
