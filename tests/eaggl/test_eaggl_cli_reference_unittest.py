...
class EagglCliReferenceTest(unittest.TestCase):
    ...
    def test_reference_factor_and_labeling_flags_round_trip(self) -> None:
        ...
        self.assertEqual(opts["full_gene_projection_method"], "direct_gene_gene")
    ...
    def test_reference_documented_flags_are_mapped_to_real_tests(self) -> None:
        ...
        flag_to_tests = {
            ...
            "--discovery-model": ["test_reference_factor_and_labeling_flags_round_trip"],
            "--gene-gene-beta-source": ["test_reference_factor_and_labeling_flags_round_trip"],
            ...
            "--no-gene-gene-excess-probability": ["test_reference_factor_and_labeling_flags_round_trip"],
            ...
            "--phi-selection-target-factor-gene-mass": ["test_phi_selection_composite_flags_round_trip_and_validate"],
            "--phi-selection-tie-tolerance": ["test_phi_selection_composite_flags_round_trip_and_validate"],
            "--phi-selection-metrics-wide-out": ["test_phi_selection_composite_flags_round_trip_and_validate"],
            "--phi-selection-metrics-long-out": ["test_phi_selection_composite_flags_round_trip_and_validate"],
            ...
            "--full-gene-projection-method": ["test_reference_factor_and_labeling_flags_round_trip"],
