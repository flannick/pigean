...
class FactorStageHelpersTest(unittest.TestCase):
    ...
    def test_write_full_gene_clusters_includes_filtered_genes_with_projected_values(self) -> None:
        ...
        self.assertIn("retained_a\t2\t1.5\t0.2\tTrue\tFactor1\tlabel1\t0.8\t0.2\t0.8\t0.2\t0.8\t0.2", content)
        self.assertIn("retained_b\t1\t0.5\t0.1\tFalse\tFactor2\tlabel2\t0.1\t0.9\t0.1\t0.9\t0.1\t0.9", content)
    ...
    def test_projection_only_pheno_cluster_stage_projects_from_gene_factors(self) -> None:
        ...
        self.assertIn("joint_capture_fraction", content)
        self.assertIn("marginal_capture_fraction", content)
        self.assertIn("marginal_lift", content)
        self.assertIn("joint_ln_bf", content)
        self.assertIn("anchor_conditional_available", content)
