...
class SharedModuleBoundaryTest(unittest.TestCase):
    ...
    def test_pigean_y_input_contract_and_dispatch_live_in_package_module(self) -> None:
        ...
        self.assertIn("pigean_y_inputs_core.read_gene_map", flat_source)
        self.assertIn("pigean_y_inputs_core.init_gene_locs", flat_source)
        self.assertIn("pigean_y_inputs_core.apply_gene_covariates_and_correct_huge", flat_source)
        ...
        self.assertNotIn("def _init_gene_locs(", flat_source)
        self.assertNotIn("def _read_gene_map(", flat_source)
        self.assertNotIn("def _apply_gene_covariates_and_correct_huge(", flat_source)
        self.assertNotIn("def _prepare_gene_covariate_regression_state(", flat_source)
        self.assertNotIn("def _maybe_append_input_gene_covariates(", flat_source)
