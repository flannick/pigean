...
class SharedModuleBoundaryTest(unittest.TestCase):
    ...
    def test_eaggl_legacy_main_uses_package_domain_and_io_layers(self) -> None:
        ...
        self.assertIn("eaggl_state.bind_runtime_namespace(legacy_core)", support_source)
        self.assertIn("legacy_core = load_legacy_core()", support_source)
        self.assertIn("return eaggl_domain.build_main_domain(legacy_core)", support_source)
        self.assertIn('"main": ("app", "main")', package_init_source)
        ...
        self.assertIn("try:\n    from . import state as _eaggl_state", eaggl_source)
        ...
        self.assertIn("EagglState = _eaggl_state.EagglState", eaggl_source)
        self.assertIn("_normalize_dense_gene_rows = _eaggl_state._normalize_dense_gene_rows", eaggl_source)
    ...
    def test_eaggl_factor_and_phewas_runtime_methods_live_in_package_modules(self) -> None:
        ...
        self.assertIn("try:\n    from . import state as _eaggl_state", flat_source)
        self.assertIn("EagglState = _eaggl_state.EagglState", flat_source)
        self.assertIn("_normalize_dense_gene_rows = _eaggl_state._normalize_dense_gene_rows", flat_source)
        self.assertIn("_maybe_learn_batch_hyper_after_x_read = _eaggl_state._maybe_learn_batch_hyper_after_x_read", flat_source)
