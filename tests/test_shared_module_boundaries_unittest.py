...
class SharedModuleBoundaryTest(unittest.TestCase):
    ...
    def test_pigean_dispatch_and_stage_modules_use_explicit_services_not_domain(self) -> None:
        ...
        self.assertIn("def compute_beta_tildes(", model_source)
        self.assertIn("def compute_multivariate_beta_tildes(", model_source)
        self.assertIn("def compute_logistic_beta_tildes(", model_source)
        self.assertIn("def finalize_regression(", model_source)
        self.assertIn("def correct_beta_tildes(", model_source)
        self.assertIn("def write_gene_set_statistics(", outputs_source)
        self.assertIn("def write_phewas_gene_set_statistics(", outputs_source)
        self.assertIn("def write_gene_statistics(", outputs_source)
        self.assertIn("def write_gene_gene_set_statistics(", outputs_source)
        self.assertIn("def write_phewas_statistics(", outputs_source)
        ...
        self.assertIn("return pigean_model.compute_beta_tildes(", state_source)
        self.assertIn("return pigean_model.compute_multivariate_beta_tildes(", state_source)
        self.assertIn("return pigean_model.compute_logistic_beta_tildes(", state_source)
        self.assertIn("return pigean_model.finalize_regression(", state_source)
        self.assertIn("return pigean_model.correct_beta_tildes(", state_source)
        self.assertIn("return pigean_outputs.write_gene_set_statistics(", state_source)
        self.assertIn("return pigean_outputs.write_phewas_gene_set_statistics(", state_source)
        self.assertIn("return pigean_outputs.write_gene_statistics(", state_source)
        self.assertIn("return pigean_outputs.write_gene_gene_set_statistics(", state_source)
        self.assertIn("return pigean_outputs.write_phewas_statistics(", state_source)
    ...
    def test_pigean_runtime_helpers_live_in_package_runtime_module(self) -> None:
        ...
        self.assertIn("class PhewasLabelState:", state_source)
        ...
        self.assertIn("def gene_set_regression_state(self):", state_source)
        self.assertIn("def gene_signal_huge_state(self):", state_source)
        self.assertIn("def model_summary_state(self):", state_source)
    ...
    def test_pigean_y_input_contract_and_dispatch_live_in_package_module(self) -> None:
        ...
        self.assertIn("def initialize_huge_gwas_state(", huge_source)
        self.assertIn("def remap_huge_gene_probability_rows(", huge_source)
        self.assertIn("def align_huge_gene_covariates_to_gene_list(", huge_source)
        self.assertIn("def compute_huge_variant_logbf_and_posteriors(", huge_source)
        self.assertIn("def filter_huge_variants_for_signal_search(", huge_source)
        ...
        self.assertNotIn("def _initialize_huge_gwas_state(", state_source)
        self.assertNotIn("def _remap_huge_gene_probability_rows(", state_source)
        self.assertNotIn("def _align_huge_gene_covariates_to_gene_list(", state_source)
        self.assertNotIn("def _compute_huge_variant_logbf_and_posteriors(", state_source)
        self.assertNotIn("def _filter_huge_variants_for_signal_search(", state_source)
        self.assertIn("_pigean_huge_module().read_huge_s2g_probabilities(", state_source)
        self.assertIn("_pigean_huge_module().read_huge_input_credible_sets(", state_source)
        self.assertIn("_pigean_huge_module().initialize_huge_gwas_state(self)", state_source)
        self.assertIn("_pigean_huge_module().remap_huge_gene_probability_rows(", state_source)
        self.assertIn("_pigean_huge_module().align_huge_gene_covariates_to_gene_list(", state_source)
        self.assertIn("_pigean_huge_module().compute_huge_variant_logbf_and_posteriors(", state_source)
        self.assertIn("_pigean_huge_module().filter_huge_variants_for_signal_search(", state_source)
    ...
    def test_pegs_shared_gene_io_and_huge_cache_own_extracted_helpers(self) -> None:
        ...
        output_tables_source = (REPO_ROOT / "src" / "pegs_shared" / "output_tables.py").read_text(encoding="utf-8")
        ...
        self.assertIn("def write_gene_set_statistics(", output_tables_source)
        self.assertIn("def write_phewas_gene_set_statistics(", output_tables_source)
        self.assertIn("def write_gene_statistics(", output_tables_source)
        self.assertIn("def write_gene_gene_set_statistics(", output_tables_source)
        self.assertIn("def write_phewas_statistics(", output_tables_source)
        self.assertIn("def write_factor_phewas_statistics(", output_tables_source)
        ...
        self.assertIn("from pegs_shared.x_runtime import", pegs_utils_source)
        self.assertIn("from pegs_shared.output_tables import", pegs_utils_source)
        ...
        self.assertNotIn("def initialize_read_x_batch_seed_state(", pegs_utils_source)
        self.assertNotIn("def initialize_filtered_gene_set_state(", pegs_utils_source)
        self.assertNotIn("def maybe_prepare_filtered_correlation(", pegs_utils_source)
        self.assertNotIn("def resolve_read_x_run_logistic(", pegs_utils_source)
        self.assertNotIn("def run_read_x_ingestion(", pegs_utils_source)
        self.assertNotIn("def make_add_to_x_handler(", pegs_utils_source)
        self.assertNotIn("def ingest_x_inputs(", pegs_utils_source)
        self.assertNotIn("def standardize_qc_metrics_after_x_read(", pegs_utils_source)
        self.assertNotIn("def maybe_correct_gene_set_betas_after_x_read(", pegs_utils_source)
        self.assertNotIn("def maybe_limit_initial_gene_sets_by_p(", pegs_utils_source)
        self.assertNotIn("def maybe_prune_gene_sets_after_x_read(", pegs_utils_source)
        self.assertNotIn("def initialize_hyper_defaults_after_x_read(", pegs_utils_source)
        self.assertNotIn("def maybe_adjust_overaggressive_p_filter_after_x_read(", pegs_utils_source)
        self.assertNotIn("def apply_post_read_gene_set_size_and_qc_filters(", pegs_utils_source)
        self.assertNotIn("def record_read_x_counts(", pegs_utils_source)
        self.assertNotIn("def write_gene_set_statistics(", pegs_utils_source)
        self.assertNotIn("def write_phewas_gene_set_statistics(", pegs_utils_source)
        self.assertNotIn("def write_gene_statistics(", pegs_utils_source)
        self.assertNotIn("def write_gene_gene_set_statistics(", pegs_utils_source)
        self.assertNotIn("def write_phewas_statistics(", pegs_utils_source)
        self.assertNotIn("def write_factor_phewas_statistics(", pegs_utils_source)
    ...
    def test_eaggl_main_support_owns_runtime_support_surface(self) -> None:
        ...
        self.assertIn("class PhewasPhenoState:", state_source)
        self.assertIn("class GeneSetRegressionState:", state_source)
        self.assertIn("class GeneSignalHugeState:", state_source)
        self.assertIn("class FactorModelState:", state_source)
        self.assertIn("Current stable deep-engine slices:", state_source)
        self.assertIn("def _initialize_state_slice_defaults(self):", state_source)
        self.assertIn("def _refresh_state_slice(self, slice_name, slice_type):", state_source)
        self.assertIn("def phewas_pheno_state(self):", state_source)
        self.assertIn("def gene_set_regression_state(self):", state_source)
        self.assertIn("def gene_signal_huge_state(self):", state_source)
        self.assertIn("def factor_model_state(self):", state_source)
    ...
    def test_eaggl_factor_and_phewas_runtime_methods_live_in_package_modules(self) -> None:
        ...
        self.assertIn("def prepare_phewas_phenos_from_file(", phewas_source)
        self.assertIn("def read_phewas_file_batch(", phewas_source)
        self.assertIn("def accumulate_standard_phewas_outputs(", phewas_source)
        self.assertIn("def accumulate_factor_phewas_outputs(", phewas_source)
        self.assertIn("def run_factor_phewas_batch(", phewas_source)
        self.assertIn("def run_standard_phewas_batch(", phewas_source)
        self.assertIn("def run_phewas(", phewas_source)
        self.assertIn("def compute_beta_tildes(", regression_source)
        self.assertIn("def compute_multivariate_beta_tildes(", regression_source)
        ...
        self.assertNotIn("def _prepare_phewas_phenos_from_file(", state_source)
        self.assertNotIn("def _read_phewas_file_batch(", state_source)
        self.assertNotIn("def _accumulate_standard_phewas_outputs(", state_source)
        self.assertNotIn("def _accumulate_factor_phewas_outputs(", state_source)
        self.assertNotIn("def _run_factor_phewas_batch(", state_source)
        self.assertNotIn("def _run_standard_phewas_batch(", state_source)
        self.assertNotIn("def _compute_beta_tildes(", state_source)
        self.assertNotIn("def _compute_multivariate_beta_tildes(", state_source)
        self.assertNotIn("def _compute_robust_betas(", state_source)
        self.assertNotIn("def _finalize_regression(", state_source)
    ...
    def test_legacy_core_naming_policy_is_explicit(self) -> None:
        ...
        self.assertIn("PhewasPhenoState", canonical_doc)
        self.assertIn("GeneSetRegressionState", canonical_doc)
        self.assertIn("GeneSignalHugeState", canonical_doc)
        self.assertIn("FactorModelState", canonical_doc)
        ...
        self.assertIn("PhewasPhenoState", readme)
        self.assertIn("GeneSetRegressionState", readme)
        self.assertIn("GeneSignalHugeState", readme)
        self.assertIn("FactorModelState", readme)
    ...
    def test_shared_types_use_concrete_runtime_annotations(self) -> None:
        ...
        pigean_state = importlib.import_module("pigean.state")
        eaggl_state = importlib.import_module("eaggl.state")
        ...
        pigean_summary_hints = get_type_hints(pigean_state.ModelSummaryState)
        eaggl_phewas_hints = get_type_hints(eaggl_state.PhewasPhenoState)
        ...
        self.assertEqual(hyper_hints["ps"], pegs_types.OptionalVectorLike)
        self.assertEqual(pigean_phewas_hints["phenos"], pegs_types.OptionalStringList)
        self.assertEqual(pigean_phewas_hints["anchor_pheno_mask"], pegs_types.OptionalVectorLike)
        self.assertEqual(pigean_reg_hints["gene_set_to_ind"], pegs_types.IndexMap | None)
        self.assertEqual(pigean_signal_hints["gene_covariates"], pegs_types.OptionalMatrixLike)
        self.assertEqual(pigean_summary_hints["param_keys"], pegs_types.StringList | None)
        self.assertEqual(eaggl_phewas_hints["phenos"], pegs_types.OptionalStringList)
        self.assertEqual(eaggl_phewas_hints["anchor_gene_mask"], pegs_types.OptionalVectorLike)
        self.assertEqual(eaggl_reg_hints["gene_sets"], pegs_types.OptionalStringList)
        self.assertEqual(eaggl_signal_hints["gene_covariates_mask"], pegs_types.OptionalVectorLike)
        self.assertEqual(get_type_hints(pegs_types.PhewasRuntimeState)["gene_pheno_Y"], pegs_types.OptionalMatrixLike)
