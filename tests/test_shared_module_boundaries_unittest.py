...
class SharedModuleBoundaryTest(unittest.TestCase):
    ...
    def test_pigean_package_app_owns_main_dispatch(self) -> None:
        ...
        self.assertIn("def build_legacy_services(legacy_module) -> PigeanMainServices:", support_source)
        ...
        self.assertIn("from pigean import main_support as pigean_main_support", flat_source)
        self.assertIn("_pigean_app.run_main_pipeline(", flat_source)
        self.assertIn("services=pigean_main_support.build_legacy_services(sys.modules[__name__])", flat_source)
        self.assertIn("pigean_main_support.build_legacy_services(sys.modules[__name__])", flat_source)
    ...
    def test_pigean_runtime_helpers_live_in_package_runtime_module(self) -> None:
        ...
        self.assertIn("pigean_state.bind_legacy_namespace(legacy_core)", support_source)
        ...
        self.assertIn("from pigean import state as pigean_state", flat_source)
        self.assertIn("from pigean.state import PigeanState", flat_source)
        self.assertIn("pigean_state.bind_legacy_namespace(sys.modules[__name__])", flat_source)
        ...
        self.assertNotIn("class PigeanState(object):", flat_source)
    ...
    def test_pigean_beta_and_prior_math_live_in_package_model_module(self) -> None:
        ...
        self.assertNotIn("def calculate_gene_set_statistics(self", flat_source)
        self.assertNotIn("def calculate_non_inf_betas(self", flat_source)
        self.assertNotIn("def calculate_priors(self", flat_source)
    ...
    def test_core_legacy_launchers_use_pegs_shared_module_namespaces(self) -> None:
        ...
        self.assertIn("import pegs_shared.cli as pegs_cli", pigean_source)
