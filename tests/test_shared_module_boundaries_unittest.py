...
class SharedModuleBoundaryTest(unittest.TestCase):
    ...
    def test_pigean_package_app_owns_main_dispatch(self) -> None:
        ...
        self.assertIn("from . import cli as pigean_cli", app_source)
        self.assertIn("from . import dispatch as pigean_dispatch", app_source)
        self.assertIn("class PigeanAppDomain:", app_source)
        self.assertIn("def run_main_pipeline(options, mode):", app_source)
        self.assertIn("return pigean_dispatch.run_main_pipeline(_APP_DOMAIN, options, mode)", app_source)
        self.assertIn('_LEGACY_CORE = None', app_source)
        self.assertIn('importlib.import_module("pigean_legacy_main")', app_source)
