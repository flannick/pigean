...
class SharedModuleBoundaryTest(unittest.TestCase):
    ...
    def test_eaggl_main_support_owns_runtime_support_surface(self) -> None:
        ...
        self.assertIn("eaggl_state.bind_runtime_namespace(sys.modules[__name__])", support_source)
        ...
        self.assertIn("def bind_runtime_namespace(runtime_module=None):", state_source)
        self.assertIn("class EagglState(object):", state_source)
        self.assertIn("GeneSetData = EagglState", state_source)
        self.assertIn("runtime_module = eaggl_main_support", state_source)
