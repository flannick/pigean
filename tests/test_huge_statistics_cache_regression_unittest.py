    ...
    def _write_tiny_huge_fixtures(cls) -> None:
        ...
        cls.gwas_file.write_text(
            "\n".join(
                [
                    "CHR\tPOS\tP\tBETA\tSE",
                    "1\t100100\t1e-7\t0.20\t0.037546530337571084",
                    "1\t100300\t1e-6\t-0.10\t0.020443047967832226",
                    "1\t200100\t5e-8\t0.30\t0.05503263910953657",
                    "1\t250000\t5e-5\t0.05\t0.012328549995532977",
                ]
            )
            + "\n",
            encoding="utf-8",
