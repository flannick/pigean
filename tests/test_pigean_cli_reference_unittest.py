...
class PigeanCliReferenceTest(unittest.TestCase):
    ...
    def test_reference_documented_flags_are_mapped_to_real_tests(self) -> None:
        ...
        flag_to_tests = {
            ...
            "--gene-universe-in": ["test_reference_gene_list_file_mode_runs", "test_positive_controls_only_requires_explicit_gene_universe", "test_gene_universe_options_round_trip_in_effective_config", "test_gene_stats_input_respects_explicit_gene_universe_file", "test_toy_outputs_are_nonempty_and_include_expected_t2d_genes"],
            "--gene-universe-id-col": ["test_reference_gene_list_file_mode_runs", "test_gene_universe_options_round_trip_in_effective_config", "test_gene_stats_input_respects_explicit_gene_universe_file", "test_toy_outputs_are_nonempty_and_include_expected_t2d_genes"],
            "--gene-universe-no-header": ["test_reference_gene_list_file_mode_runs", "test_gene_universe_options_round_trip_in_effective_config"],
            "--gene-universe-from-y": ["test_gene_stats_input_requires_explicit_gene_universe", "test_positive_controls_only_requires_explicit_gene_universe"],
            "--gene-universe-from-x": ["test_gene_stats_input_requires_explicit_gene_universe", "test_positive_controls_only_requires_explicit_gene_universe"],
            ...
            "--gene-set-exclude-in": ["test_betas_rerun_bundle_roundtrip_exclude_and_effective_config"],
            "--gene-set-exclude-id-col": ["test_betas_rerun_bundle_roundtrip_exclude_and_effective_config"],
            "--gene-set-exclude-no-header": ["test_betas_rerun_bundle_roundtrip_exclude_and_effective_config"],
            ...
            "--track-filtered-beta-uncorrected-mode": ["test_track_filtered_beta_uncorrected_defaults_on_for_gibbs", "test_track_filtered_beta_uncorrected_mode_can_be_set_explicitly"],
        ...
        test_files = [
            ...
            self.repo_root / "tests/test_pigean_rerun_bundle_unittest.py",
